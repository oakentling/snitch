...
impl<'a> InstructionTranslator<'a> {
    ...
    /// Emit code to calculate new latency.
    ///
    /// Latency calculation for memory accesses always associated to correct register.
    ///
    ...
    unsafe fn emit_latency_cycle(
        ...
        // If there is a register where memory loads to as well, get it
